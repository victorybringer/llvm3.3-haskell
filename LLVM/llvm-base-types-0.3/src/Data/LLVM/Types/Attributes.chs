...
{#enum LinkageType {} deriving (Eq,Generic,NFData) #}
...
--instance NFData LinkageType where rnf = genericRnf
defaultLinkage :: LinkageType
defaultLinkage = LTExternal

{#enum VisibilityStyle {} deriving (Eq,Generic,NFData) #}
...
--instance NFData VisibilityStyle where rnf = genericRnf
defaultVisibility :: VisibilityStyle
defaultVisibility = VisibilityDefault

{#enum CAtomicOrdering as AtomicOrdering {} deriving (Eq,Generic,NFData) #}
...
--instance NFData AtomicOperation where rnf = genericRnf

{#enum LandingPadClause {} deriving (Eq,Generic,NFData) #}

instance Show LandingPadClause where
  show LPCatch = "catch"
  show LPFilter = "filter"

--instance NFData LandingPadClause where rnf = genericRnf

{#enum ArithFlags {} deriving (Eq,Generic,NFData) #}
...
--instance NFData ArithFlags where rnf = genericRnf
defaultArithFlags :: ArithFlags
defaultArithFlags = ArithNone

{#enum CmpPredicate {underscoreToCase} deriving (Eq,Generic,NFData) #}
...
--instance NFData CmpPredicate where rnf = genericRnf


{#enum CallingConvention {} deriving (Eq,Generic,NFData) #}
...
--instance NFData CallingConvention where rnf = genericRnf
...
--instance NFData ParamAttribute where rnf = genericRnf
...
--instance NFData FunctionAttribute where rnf = genericRnf
